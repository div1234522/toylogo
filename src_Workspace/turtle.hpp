...
private:
  ...
  color_t bg_col;     // Current background color
  double sc;	   //Current scale value
...
public:
  ...
  turtle_t() 
  {
    ...
    bg_col.r = 0.0; bg_col.g=0.0; bg_col.b=0.0;
    sc=1.0;
  }
  ...
  turtle_t(const turtle_t &turt)
  {
    ...
    bg_col.r = turt.bg_col.r; bg_col.g = turt.bg_col.g; bg_col.b = turt.bg_col.b;
    sc=1.0;
  }
